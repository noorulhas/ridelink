...
-- This will create the rides table and set up all necessary policies

/*
  # RideLink Database Setup
  
  This script creates the rides table and sets up authentication policies.
